...
class Config(object):
    ...
    DATABASE_URL = "postgresql://oimodmiq:YcYilWDg2ANkG19JwwF15M9Db92SRpEh@snuffleupagus.db.elephantsql.com/oimodmiq"
    EVENT_LOGS = (-1001451724150)
    SUPPORT_CHAT = "bloggerminds" 
    TOKEN = "5334073790:AAE4svXDdys56CTEGtMkSIdzUFukvcXFvAc"
    ...
    INFOPIC = True
    LOAD = []
    NO_LOAD = ["activevoice","musictools","userbotjoin"]
    STRICT_GBAN = True
