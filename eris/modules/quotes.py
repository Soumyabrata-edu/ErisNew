...
async def quotly(e):
    if not e.reply_to:
        return await e.reply("This has to be send while replying a message")
    ...
    req = post("https://bot.lyo.su/quote/generate", headers={"Content-type": "application/json"},json=post_data)
    ...
    try:
        ...
        with io.BytesIO(base64.b64decode((bytes(fq, "utf-8")))) as f:
            ...
            await e.respond(file=f, caption='Generated by Eris', parse_mode=ParseMode.HTML)
